...
def trigger_mqtt(test):
    ...
    dstl_kill_ssh_process(test, 'ssh_server', 'mosquitto -p {} -v'.format(test.mqtt_server.port_active), indexes_to_kill=[1])
...
def trigger_mqtt2(test):
    ...
    test.mqtt_server = MqttServer("IPv4", extended=True)
    test.expect(test.mqtt_server.dstl_run_mqtt_server())
    print('---------------1 ', test.ssh_server_2.last_response)
    ...
    print('---------------2 ', test.ssh_server_2.last_response)
    ...
    print('---------------3 ', test.ssh_server_2.last_response)
    ...
    print('---------------4 ', test.ssh_server_2.last_response)
    ...
    test.expect(f"Received SUBSCRIBE from {test.client_id}" and
                ...
                test.mqtt_server.dstl_read_data_on_ssh_server())
    print('---------------5 ', test.ssh_server_2.last_response)
    ...
    test.sleep(10)
    print('---------------6 ', test.ssh_server_2.last_response)
    ...
    print('---------------7 ', test.ssh_server_2.last_response)
