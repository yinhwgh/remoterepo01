...
#location: Beijing
#TC0104574.001 Actia_Configuration_HTTPS_DriverTurnOff
#Hints:
...
class Test(BaseTest):
    ...
    """  This case is intended to simulate customer's driver turns off vehicle power.
    ...
    def run(test):
        ...
        test.log.info("TC0104574.001 - Actia_Configuration_HTTPS_DriverTurnOff")
        ...
        test.log.info('Step 5: The module shuts down.')
        ...
        test.log.info('********** TC0104574.001 - Actia_Configuration_HTTPS_DriverTurnOff END **************')
