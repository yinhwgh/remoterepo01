...
#location: Beijing
#TC0104571.001 - Actia_DataCollection_TransparentTCPS_ClientServerAuthentication_CatM_5min
#Hints:
#The parameters such as srv_id, echo_server_address and secopt should be defined in local.cfg currently.
#Take an example:
# echo_server_address="10.163.27.30"
# srv_id = 1
# etx_char = '26'
# secopt = 1
...
class Test(BaseTest):
    ...
    """ This case is intended to send data per 5 minutes through transparent TCPS socket connection
        with Client and Server Authentication upon Cat.M network.
        Before running this script, please install certification with Client and Server Authentication on module.
    """
    ...
    def run(test):
        ...
        test.log.info("TC0104571.001 - Actia_DataCollection_TransparentTCPS_ClientServerAuthentication_CatM_5min")
        ...
        test.log.info('********** TC0104571.001 - Actia_DataCollection_TransparentTCPS_ClientServerAuthentication_CatM_5min END **************')
