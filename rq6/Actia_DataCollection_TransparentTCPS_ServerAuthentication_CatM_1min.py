...
#location: Beijing
#TC0104566.001 Actia_DataCollection_TransparentTCPS_ServerAuthentication_DriverTurnOff
#Hints:
...
class Test(BaseTest):
    ...
    """ this case is intended to simulate customer's driver turns off vehicle power before the summary has been sent.
        Module will shut down randomly during sending data per 5 minutes through transparent TCPS socket connection
        ...
        The scrpt will cover IPV6 configuration.
    """
    ...
    def run(test):
        ...
        test.log.info("TC0104566.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_DriverTurnOff")
        ...
        connection_setup_dut = test.dut.dstl_get_connection_setup_object(ip_version='IPV6')
        ...
        client_profile = SocketProfile(test.dut, 1, connection_setup_dut.dstl_get_used_cid(),
                                       protocol='tcp', ip_version='IPV6', host=test.tcps_echo_server_ipv6,
                                       port=test.tcps_echo_server_port_ipv6,etx_char='26', secopt=1, secure_connection=True)
        ...
        tStart = time.time()
        times = 0
        # Send buffered data every 1 minute, keep 10 hours
        while (time.time() - tStart - 60 * times >= 0):
            test.log.info(
        ...
        test.log.info('Step 6: Send summary data 2KB~3KB.')
        sSummaryDataIn = 'B'
        ...
        test.log.info('********** TC0104566.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_DriverTurnOff END **************')
