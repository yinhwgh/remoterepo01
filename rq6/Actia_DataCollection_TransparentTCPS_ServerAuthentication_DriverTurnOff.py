...
#location: Beijing
#TC0104558.001 Actia_DataCollection_TransparentTCPS_ServerAuthentication_CatM_5min
#Hints:
...
class Test(BaseTest):
    ...
    """ This case is intended to send data per 5 minutes through transparent TCPS socket connection
        ...
        This case is used for verifying the normal flow of user case named Vehicle data collection.
    ...
    def run(test):
        ...
        test.log.info("TC0104558.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_CatM_5min")
        ...
        while (time.time() - tStart - 300 * times >= 0):
            ...
            if '>MC:   DCD0: 0' in test.dut.devboard.last_response:
                ...
                test.log.info('FAIL: Response NOK.')
        ...
        test.log.info('Step 6: After sending data random 1-3 hours, the module shuts down.')
        ...
        test.log.info('********** TC0104558.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_CatM_5min END **************')
