...
#location: Beijing
#TC0104560.001 Actia_DataCollection_TransparentTCPS_ServerAuthentication_GSM_5min
#Hints:
...
class Test(BaseTest):
    ...
    """
     ...
     with Server Authentication upon GSM network.
    ...
    def run(test):
        ...
        test.log.info("TC0104560.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_GSM_5minn")
        ...
        test.log.info('********** TC0104560.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_GSM_5minn END **************')
