...
#location: Beijing
#TC0104568.001 - Actia_DataCollection_TransparentTCP_CatM_5min
#Hints:
#The parameters such as srv_id, echo_server_address should be defined in local.cfg currently.
...
class Test(BaseTest):
    ...
    """ The intension is to send data per 5 minutes through transparent TCP socket connection upon Cat.M network."""
    ...
    def run(test):
        ...
        test.log.info("TC0104568.001 - Actia_DataCollection_TransparentTCP_CatM_5min")
        ...
        test.log.step('Step 3: Configure IPv4 or IPv6 transparent TCP socket connection.')
        ...
        client_profile = SocketProfile(test.dut, 1, connection_setup_dut.dstl_get_used_cid(),
                                       protocol="tcp", host=test.tcp_echo_server_ipv4,port=test.tcp_echo_server_port_ipv4,
                                        etx_char='26')
        ...
        test.log.info('********** TC0104568.001 - Actia_DataCollection_TransparentTCP_CatM_5min END **************')
