...
def main_process(test):
    ...
    test.expect(test.dut.at1.send_and_verify('AT^SISO=1', ".*OK.*"), msg="Start Error Handong D")
    ...
    test.expect(test.dut.at1.send_and_verify('AT+CGATT=1', ".*OK.*"))
    test.sleep(10)
    test.log.info("******Confirm service is down******")
    test.expect(test.dut.at1.send_and_verify('AT^SISI=1', ".*OK.*"))
    test.log.info("******Close the service******")
    test.expect(test.dut.at1.send_and_verify('AT^SISC=1', ".*OK.*"))
    test.log.info("******Confirm service was closed******")
    test.expect(test.dut.at1.send_and_verify('AT^SISI=1', ".*OK.*"))
