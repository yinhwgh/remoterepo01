...
class Test(BaseTest):
    """
     TC0107802.001-Resmed_eHealth_DownloadFile_ExceptionalFlow_C
    """
...
def main_process(test, restart=0):
    ...
    if not dstl_compare_cipher_suite_without_error(test, "123 CIPHER is 456"):
        print('Do next action to report error!')
