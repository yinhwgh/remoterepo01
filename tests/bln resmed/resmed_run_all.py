...
from tests.rq6.resmed_ehealth_shut_down_module_normal_flow_stress_test import main_process as us_shutdownmodule_nf_stress
import random
...
class Test(BaseTest):
    ...
    def run(test):
        ...
        test.log.step("Run TC0107797.001 - Resmed_eHealth_DownloadFile_AlternativeFlow.")
        #test.ssh_server.close()
        test.sleep(10)
        us_downloadfile_af(test)
