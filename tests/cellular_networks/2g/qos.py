...
class Test(BaseTest):
    '''
    TC0084468.001 - QoS
    Intention: Ensure, that the SUT is able to establish GPRS dial-up connections by the negotiation of different quality of service profiles.
    '''
    ...
    def setup(test):
        ...
        test.log.info('*** TestCase: TC0084468.001 - QoS Start ***')
    ...
    def run(test):
        ...
        min_cgqreq_precedence_value, min_cgqreq_delay_value, min_cgqreq_reliability_value, min_cgqreq_peak_value, min_cgqreq_mean_value = test.get_min_cgqreq_parameter()
        min_cgqmin_precedence_value, min_cgqmin_delay_value, min_cgqmin_reliability_value, min_cgqmin_peak_value, min_cgqreq_mean_value = test.get_min_cgqmin_parameter()
        for cid in range(1,17):
            test.set_cgqreq_param(cid, min_cgqreq_precedence_value, min_cgqreq_delay_value, min_cgqreq_reliability_value, min_cgqreq_peak_value, min_cgqreq_mean_value)
            test.set_cgqmin_param(cid, min_cgqmin_precedence_value, min_cgqmin_delay_value, min_cgqmin_reliability_value, min_cgqmin_peak_value, min_cgqreq_mean_value)
        ...
        max_cgqreq_precedence_value, max_cgqreq_delay_value, max_cgqreq_reliability_value, max_cgqreq_peak_value, max_cgqreq_mean_value = test.get_max_cgqreq_parameter()
        max_cgqmin_precedence_value, max_cgqmin_delay_value, max_cgqmin_reliability_value, max_cgqmin_peak_value, max_cgqreq_mean_value = test.get_max_cgqmin_parameter()
        ...
        for cid in range(1, 17):
            ...
            test.log.info('4.1 set the minimum acceptable QoS profile to network subscribed')
            test.set_cgqreq_param(cid, min_cgqreq_precedence_value, min_cgqreq_delay_value, min_cgqreq_reliability_value, min_cgqreq_peak_value, min_cgqreq_mean_value)
            test.expect(test.dut.at1.send_and_verify('at+cgqreq?', '.*OK.*'))
            test.set_cgqmin_param(cid, min_cgqmin_precedence_value, min_cgqmin_delay_value, min_cgqmin_reliability_value, min_cgqmin_peak_value, min_cgqreq_mean_value)
            test.expect(test.dut.at1.send_and_verify('at+cgqmin?', '.*OK.*'))
            ...
            if test.dut.project == 'VIPER':
                test.log.info('4.2. activate the related PDP context')
                ...
                test.log.info('4.3. deactivate the active PDP context')
            ...
            test.log.info('4.4. set the minimum acceptable LTE QoS profile to maximum values')
            test.set_cgqreq_param(cid, max_cgqreq_precedence_value, max_cgqreq_delay_value, max_cgqreq_reliability_value, max_cgqreq_peak_value, max_cgqreq_mean_value)
            test.expect(test.dut.at1.send_and_verify('at+cgqreq?', '.*OK.*'))
            test.set_cgqmin_param(cid, max_cgqmin_precedence_value, max_cgqmin_delay_value, max_cgqmin_reliability_value, max_cgqmin_peak_value, max_cgqreq_mean_value)
            test.expect(test.dut.at1.send_and_verify('at+cgqmin?', '.*OK.*'))
    ...
    def cleanup(test):
        test.log.info('*** TestCase: TC0084468.001 - QoS End***')
    ...
    def get_max_cgqreq_parameter(test):
        ...
        test.log.info('Max CEQREQ PRECEDENCE: {}\n Max CEQREQ DELAY: {}\n Max CEQREQ RELIABILITY: {}\n Max CEQREQ PEAK: {}\n Max CEQREQ MEAN: {}'.format(max_ceqreq_precedence, max_ceqreq_delay,
                      max_ceqreq_reliability, max_ceqreq_peak, max_ceqreq_mean))
    ...
    def get_max_cgqmin_parameter(test):
        ...
        test.log.info('Max CEQMIN PRECEDENCE: {}\n Max CEQREQ DELAY: {}\n Max CEQREQ RELIABILITY: {}\n Max CEQREQ PEAK: {}\n Max CEQREQ MEAN: {}'.format(max_cgqmin_precedence, max_cgqmin_delay,
                      max_cgqmin_reliability, max_cgqmin_peak, max_cgqmin_mean))
    ...
    def get_min_cgqreq_parameter(test):
        ...
        test.log.info(
            'Min CEQREQ PRECEDENCE: {}\n Min CEQREQ DELAY: {}\n Min CEQREQ RELIABILITY: {}\n Min CEQREQ PEAK: {}\n Min CEQREQ MEAN: {}'.format(
                min_cgqreq_precedence, min_cgqreq_delay,
    ...
    def get_min_cgqmin_parameter(test):
        ...
        test.log.info(
            'Min CEQMIN PRECEDENCE: {}\n Min CEQREQ DELAY: {}\n Min CEQREQ RELIABILITY: {}\n Min CEQREQ PEAK: {}\n Min CEQREQ MEAN: {}'.format(
                min_cgqmin_precedence, min_cgqmin_delay,
                min_cgqmin_reliability, min_cgqmin_peak, min_cgqmin_mean))
    ...
    def set_cgqreq_param(test, cid, min_cgqreq_precedence_value, min_cgqreq_delay_value, min_cgqreq_reliability_value, min_cgqreq_peak_value, min_cgqreq_mean_value):
        test.expect(test.dut.at1.send_and_verify(f'at+cgqreq={cid},{min_cgqreq_precedence_value},{min_cgqreq_delay_value},{min_cgqreq_reliability_value},{min_cgqreq_peak_value},{min_cgqreq_mean_value}', 'OK'))

    def set_cgqmin_param(test, cid, min_cgqmin_precedence_value, min_cgqmin_delay_value, min_cgqmin_reliability_value, min_cgqmin_peak_value, min_cgqmin_mean_value):
        test.expect(test.dut.at1.send_and_verify(f'at+cgqmin={cid},{min_cgqmin_precedence_value},{min_cgqmin_delay_value},{min_cgqmin_reliability_value},{min_cgqmin_peak_value},{min_cgqmin_mean_value}', 'OK'))
