...
class Test(BaseTest):
    '''
        TC0000187.001 - IndCeerRelCauseGroup4
        Check presentation of  indicators "ceer" if parameter <CeerRelCauseGroup> is set to 4
        4 = PS internal cause
    ...
    def run(test):
        ...
        test.expect(test.dut.at1.send_and_verify('AT^SIND="ceer",1,4', expect='.*OK.*'))
        test.expect(test.dut.at1.send_and_verify('AT^SIND="ceer",2', expect='.*4*'))
