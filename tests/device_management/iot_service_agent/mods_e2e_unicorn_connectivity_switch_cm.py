...
# location: Berlin
# Test case: UNISIM01-211
#
# add workaround for connection interval set to 1 day (22.09.2021)
...
class Test(BaseTest):
    ...
    def setup(test):
        ...
        test.log.com('***** Testcase: ' + test.test_file + ' (UNISIM01-211) - Start *****')
