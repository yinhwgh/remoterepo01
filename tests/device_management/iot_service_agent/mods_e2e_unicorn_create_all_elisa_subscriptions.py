...
testkey = "UNISIM01-238"

class Test(BaseTest):
    """
    Create all subscriptions from ELISA-list on MODS-server
    """
    ...
    def setup(test):
        ...
        # id of "name": "FI-Elisa Corp-internet",   ----> "id": "143e3d0a-940a-45ea-bd28-07b043b04c79"
        #test.pool_id = '143e3d0a-940a-45ea-bd28-07b043b04c79'

        test.pool_name = "FI-Elisa Corp-internet"
    ...
    def run(test):
        ...
        file_name_iccids = "iccids_elisa_smdp_production_prp3.txt"
        ...
        result1, iccid_results_list = test.dut.dstl_create_all_subscriptions_with_pool_id(test.rest_client, iccid_list,
                                                                                          test.pool_id)
