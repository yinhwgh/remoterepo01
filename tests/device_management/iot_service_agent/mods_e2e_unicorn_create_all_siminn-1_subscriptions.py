...
# location: Berlin
# test case: UNISIM01-236 - additional for "IS-Siminn-internet-1"
...
class Test(BaseTest):
    """
    Create all subscriptions from SIMINN-1 list on MODS-server
    """
    ...
    def setup(test):
        ...
        # id of "name": "IS-Siminn-internet-1",   ----> "id": "69c42d32-a206-4158-b014-bdb56fa27761"
        #test.pool_id = '69c42d32-a206-4158-b014-bdb56fa27761'

        test.pool_name = "IS-Siminn-internet-1"
    ...
    def run(test):
        ...
        file_name_iccids = "iccids_siminn-1_gcp.txt"
