...
class Test(BaseTest):
    ...
    def setup(test):
        ...
        # id of "name": "N/A-TRANSATEL-mbb",   ----> "id": "d2391564-2b1e-47a9-8a6b-24b0df43dccc"
        #test.pool_id = 'd2391564-2b1e-47a9-8a6b-24b0df43dccc'

        test.pool_name = "N/A-TRANSATEL-mbb"
