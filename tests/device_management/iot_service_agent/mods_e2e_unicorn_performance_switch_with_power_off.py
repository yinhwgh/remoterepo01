...
class Test(BaseTest):
    ...
    # 1--power off during download profile.
    ...
    def run(test):
        test.log.info('*' * 80)
        test.log.step(f'Power off test during connectivity switch.')
        test.log.info('*' * 80)
    ...
    def connectivity_switch_with_different_rat(test):
        ...
        while True:
            ...
            test.log.step(f"Step 3. Power off during connectivity switch and continue.")
