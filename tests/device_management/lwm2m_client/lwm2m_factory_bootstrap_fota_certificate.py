...
class Lwm2mFactoryBootstrapCertificate(BaseTest):
    ...
    def setup(test):
        test.server_param_file_path = r"C:\lwm2m\mods\Mods_certs\ssl-fota\carrier_apn_cfg"
        test.global_param_file_path = r"C:\lwm2m\mods\Mods_certs\ssl-fota\lwm2m_cfg"
        ...
        test.server1_address = "coap://partners-mods.gemalto.io:5683"
