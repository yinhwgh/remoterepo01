...
from dstl.auxiliary.devboard.gpio_on_devboard import dstl_set_gpio_direction
import time
...
class Test(BaseTest):
    ...
    def run(test):
        ...
        while time.time() - start_time < duration_time:
            ...
            test.dut.at1.send_and_verify('AT^SCFG="GPRS/AutoAttach"')

            test.log.step("1. Send shutdown command by gpio")
            ...
            print(">>>>>>>>>>>>>>>>>>>>>>", test.dut.devboard.last_response)
