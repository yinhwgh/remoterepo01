...
class Test(BaseTest):
    ...
    def run(test):
        test.log.info("TC0024338.002/003 PingSocketServiceWithExplicitOpen")
        ...
        test.log.info("Profile closed in previous step")
        ...
        test.expect(client_profile.dstl_get_service().dstl_reset_service_profile())
