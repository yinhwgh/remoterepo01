...
class Test(BaseTest):
    ...
    def run(test):
        ...
        test.ftpes_server = FtpesServer("IPv4", test, connection_setup.dstl_get_used_cid())
        ...
        test.expect(test.ftpes_put.dstl_get_service().dstl_open_service_profile(wait_for_default_urc=False))
