...
class Test(BaseTest):
    ...
    def run(test):
        ...
        test.write_ftp_data(eod_flag="1")
    ...
    def write_ftp_data(test, eod_flag="0"):
        test.expect(test.ftp_put.dstl_get_service().dstl_send_sisw_command_and_data(test.data_length, eod_flag=eod_flag))
        test.sleep(5)
