...
class Test(BaseTest):
    ...
    def step4to8(test, protocol):
        ...
        client_profile = SocketProfile(test.dut, 1, test.connection_setup_dut.dstl_get_used_cid(),
                                       protocol=f"{protocol}",etx_char=26)
        ...
        test.sleep(2)
        data_to_send = '12345678901234567890'*10
        ...
        for i in range(0, 2):
            ...
            test.expect(test.expect(test.r1.at1.send_and_verify(f'atd{test.dut.sim.nat_voice_nr};')))
