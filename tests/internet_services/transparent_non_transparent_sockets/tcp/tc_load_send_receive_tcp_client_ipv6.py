...
class Test(BaseTest):
    ...
    def run(test):
        ...
        test.log.info("Executing script for test case: 'TcLoadSendReceiveTcpClient_IPv6'")

        dstl_set_scfg_tcp_with_urcs(test.dut, "on")
        test.echo_server = EchoServer('IPv6', "TCP", test_duration=8)
        ...
        test.log.step("2) Set IPv6 TCP client socket profile on module")
