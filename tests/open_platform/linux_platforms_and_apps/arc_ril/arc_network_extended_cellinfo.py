...
# location: Wroclaw
# TC0103360.001 arc_network_extended_cellinfo.py
...
class ArcNetworkExtendedCellinfo (BaseTest):
    ...
    def run(test):
        ...
        test.dut.dstl_embedded_linux_run_application("LinuxArcRilEngine",
                                                     params=["FEATURE=NetworkSimAPIs",
                                                             "PROCEDURE=ARC_GetExtendedCellInfo"],
                                                     expect='(?s).*EXP: Information about 2G cell:.*ARFCN.*')
        ...
        test.dut.dstl_embedded_linux_run_application("LinuxArcRilEngine",
                                                     params=["FEATURE=NetworkSimAPIs",
                                                             "PROCEDURE=ARC_GetExtendedCellInfo"],
                                                     expect='(?s).*EXP: Information about 3G cell:.*HSDPA.*')
