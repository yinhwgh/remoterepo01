...
# location: Wroclaw
# TC0102615.001 arc_network_register_to_network_auto_wait4reg.py
...
class ArcNetworkRegisterToNetworkAutoWait4Reg(BaseTest):
    ...
    def run(test):
        ...
        test.dut.dstl_embedded_linux_run_application("LinuxArcRilEngine",
                                                     params=["FEATURE=NetworkSimAPIs",
                                                             "prefAcT=2 waitForReg=1",
                                                             "PROCEDURE=ARC_GetNetworkRegistration"],
                                                     expect='(?s).*HOME.*')
        test.dut.dstl_embedded_linux_run_application("LinuxArcRilEngine",
                                                     params=["FEATURE=NetworkSimAPIs",
        ...
        test.dut.dstl_embedded_linux_run_application("LinuxArcRilEngine",
                                                     params=["FEATURE=NetworkSimAPIs",
                                                             "prefAcT=3 waitForReg=1",
                                                             "PROCEDURE=ARC_RegisterToNetworkAutomatic"],
                                                     expect='(?s).*Preferred access technology is set LTE only.*')
        test.dut.dstl_embedded_linux_run_application("LinuxArcRilEngine",
                                                     params=["FEATURE=NetworkSimAPIs",
                                                             "prefAcT=2 waitForReg=1",
                                                             "PROCEDURE=ARC_GetNetworkRegistration"],
