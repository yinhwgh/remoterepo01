...
class Test(BaseTest):
    ...
    """
        This procedure performs upload throughput speed test using dial-up
    """
    ...
    def run(test):
        ...
        # 2. Measure data_upload_dialup_Xg_throughput
        status = test.dut.dstl_test_dialup_throughput(direction=1)
        test.expect(status)
