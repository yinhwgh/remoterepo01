...
#location: Beijing
#TC0104572.001 Actia_Configuration_HTTPS_CatM
#Hints:
...
class Test(BaseTest):
    """  This case is intended to get configuration data through HTTPS connection upon Cat.M network. """
    ...
    def run(test):
        ...
        test.log.info("TC0104572.001 - Actia_Configuration_HTTPS_CatM")
        ...
        test.log.info('********** TC0104572.001 - Actia_Configuration_HTTPS_CatM END **************')
