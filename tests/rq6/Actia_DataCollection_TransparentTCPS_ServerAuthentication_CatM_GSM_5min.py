...
#location: Beijing
#TC0104565.001 Actia_DataCollection_TransparentTCPS_ServerAuthentication_CatM_GSM_5min
#Hints:
...
class Test(BaseTest):
    ...
    """
    This case is intended to send data per 5 minutes through transparent TCPS socket connection
    with Server Authentication, when Cat.M1 and GSM are available.
    ...
    def run(test):
        ...
        test.log.info("TC0104565.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_CatM_GSM_5min ")
        test.log.info('***************************** Test Begin******************************')
        test.log.step('Step 1: Module registers to network. Cat.M1 and GSM are available, '
                      'which type network is registered depends on the network condition via UART')

        test.expect(test.dut.at1.send_and_verify('at^sxrat=9', '.*OK.*'))
        ...
        test.log.step('Step 4: Open transparent TCP socket.')
        ...
        test.log.info('********** TC0104565.001 - Actia_DataCollection_TransparentTCPS_ServerAuthentication_CatM_GSM_5min  END **************')
