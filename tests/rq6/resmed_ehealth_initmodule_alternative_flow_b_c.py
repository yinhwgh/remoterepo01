...
class Test(BaseTest):
    ...
    def run(test):
        resmed_ehealth_initmodule_normal_flow.set_run_all(True)
        print(resmed_ehealth_initmodule_normal_flow.run_all)
        ...
        main_process(test)
        resmed_ehealth_initmodule_normal_flow.set_run_all(False)
        print(resmed_ehealth_initmodule_normal_flow.run_all)
...
def NF16_goto_AF_B_restart(test):
    ...
    test.log.step('***** NF16_goto_AF_B flow end *****')
