...
# location: Beijing
# TC0107173.001 - SmartMeter_sendAlertMessage_send_first_SMS_error_exceptionalFlowA_update
# Hints:
...
class Test(BaseTest):
    ...
    def run(test):
        ...
        send_alert_message_send_first_SMS_error_exceptional_flowA_update(test)

    def cleanup(test):
        pass

def send_alert_message_send_first_SMS_error_exceptional_flowA_update(test):
    ...
    test.log.info('*** send_alert_message_send_first_SMS_error_exceptional_flowA_update begin ***')
    ...
    test.log.step('NF-08:  Send the alert as short message.--- Trigger error')
    ...
    test.log.step('NF-12: Repeat step1-8 --- NF-07: Configure the SMS parameters.')
    test.dut.dstl_collect_result('NF-12: Repeat step1-8 --- NF-07: Configure the SMS parameters.',
                                 smart_meter_init_module_normal_flow.retry(test, smart_meter_send_alert_message_alternativeFlowB_update.configure_SMS,
                                                                           smart_meter_init_module_normal_flow.AF_A_restart,
                                                                           3))

    test.log.step('NF-12: Repeat step1-8 --- NF-08:  Send the alert as short message.')
    ...
    test.log.info('*** send_alert_message_send_first_SMS_error_exceptional_flowA_update end ***')
    return True
