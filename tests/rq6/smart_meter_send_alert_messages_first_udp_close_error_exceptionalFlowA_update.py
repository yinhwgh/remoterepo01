...
# location: Beijing
# TC0107168.001 - SmartMeter_sendAlertMessage_first_udp_close_error_exceptionalFlowA_update
# Hints:
...
class Test(BaseTest):
    ...
    def run(test):
        ...
        send_alert_message_first_udp_close_error_exceptional_flowA_update(test)

    def cleanup(test):
        pass

def send_alert_message_first_udp_close_error_exceptional_flowA_update(test):
    ...
    power_loss = False
    ipVersion = "4"
    test.log.info('*** send_alert_message_first_udp_close_error_exceptional_flowA_update begin ***')
    ...
    test.dut.dstl_collect_result(
        'NF-15: Repeat step1-11 --- NF-04:  Check if really power loss or only a glitch for 9 seconds.', True)
    ...
    test.log.step('NF-15: Repeat step1-11 --- NF-07: Check if only a glitch.')
    glitch_status = False
    test.dut.dstl_collect_result('NF-15: Repeat step1-11 --- NF-07: Check if only a glitch.', True)

    test.log.step('NF-15: Repeat step1-11 --- NF-08: Configure the first UDP socket.')
    ...
    test.log.info('*** send_alert_message_first_udp_close_error_exceptional_flowA_update end ***')
...
def configure_udp1_socket(test):
    ...
    result = result & test.expect(udp_client.dstl_get_service().dstl_load_profile())
    test.sleep(2)
