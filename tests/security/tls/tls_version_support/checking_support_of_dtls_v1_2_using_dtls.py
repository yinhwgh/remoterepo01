...
class Test(BaseTest):
    """Intention: Testing if DTLSv1_2 protocol version is used during DTLS connection"""
    ...
    def run(test):
        test.log.info("TC0102307.001 - CheckingSupportOfDTLSv1_2UsingDTLS")

        test.log.step("1) Run OpenSSL server using DTLSv1_2")
