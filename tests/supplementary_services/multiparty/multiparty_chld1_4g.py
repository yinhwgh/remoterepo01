...
class multiparty_chld1_4g(BaseTest):
    ...
    def setup(test):
        ...
        test.r1.at1.send_and_verify("at^scfg?")
        test.r1.at1.send_and_verify("at+clir=2")
        test.r2.at1.send_and_verify("at+COPS?")
        test.r2.at1.send_and_verify("at^SMONI")
        test.r2.at1.send_and_verify("at+cimi")
        test.r2.at1.send_and_verify("at^scfg?")
        test.r2.at1.send_and_verify("at+clir=2")
    ...
    def cleanup(test):
        ...
        test.r1.at1.send_and_verify("at+clir=0")
        test.r2.at1.send_and_verify("at+clir=0")
