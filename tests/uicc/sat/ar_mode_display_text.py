...
# location: Beijing
# TC0104221.001 - TpSATDisplayText_AR
from dstl.usat import sim_instance

"""
This test case is intended to test the SIM proactive command "DisplayText"
...
class TpSATDisplayText(BaseTest):
    ...
    def run(test):
        displaytext_applet_sstk(test, 'MenuApplet')
...
def displaytext_applet_sstk(test,trigger_mode):
    # *** set Proactive_Command and Terminal_Response
    proactive_cmd = 'D0180103032101020281020D0D04444953504C41592D54455854'
    terminal_response = '010303210102028281030100'
    if trigger_mode == 'MenuApplet':
        ...
        test.log.info("***** Update the EF record #1 Display Text command ****")
    ...
    if trigger_mode == 'MenuApplet':
        test.log.info("**** [SSTA=0]: Trigger execution of record #1 Display Text command ****")
