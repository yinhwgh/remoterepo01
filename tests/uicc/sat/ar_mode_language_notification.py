...
# location: Beijing
# TC0103961.001 - TpSATLanguageNotification
from dstl.usat import sim_instance

"""
This test case is intended to test the SIM proactive command "Language Notification"
...
class TpSATLanguageNotification(BaseTest):
    ...
    def run(test):
        language_applet_sstk(test, 'MenuApplet')
...
def language_applet_sstk(test,trigger_mode):
    # *** set Proactive_Command and Terminal_Response
    proactive_cmd = 'D00D810301350182028182AD02656E'
    terminal_response = '810301350102028281030100'
    if trigger_mode == 'MenuApplet':
        ...
        test.log.info("***** Update the EF record #1 Language Notification command ****")
    ...
    if trigger_mode == 'MenuApplet':
        test.log.info("**** [SSTA=0]: Trigger execution of record #1 Language Notification command ****")
