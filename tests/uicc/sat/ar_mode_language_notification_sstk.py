...
# location: Beijing
# TC0104262.001 - TpSATLanguageNotificationSSTK
...
from tests.uicc.sat.ar_mode_language_notification import language_applet_sstk
...
class TpSATLanguageNotification(BaseTest):
    ...
    def run(test):
        language_applet_sstk(test, 'AT^SSTK')
