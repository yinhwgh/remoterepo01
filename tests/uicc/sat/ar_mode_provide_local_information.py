...
# location: Beijing
# TC0104219.001 - TpSATProvideLocalInformation
from dstl.usat import sim_instance

"""
This test case is intended to test the SIM proactive command "Provide Local Information"
...
class TpSATProvideLocalInformation(BaseTest):
    ...
    def run(test):
        localinformation_applet_sstk(test, 'MenuApplet')
...
def localinformation_applet_sstk(test,trigger_mode):
    # *** set Proactive_Command and Terminal_Response
    proactive_cmd = 'D009010309260102028182'
    terminal_response = '010309260102028281030100'
    if trigger_mode == 'MenuApplet':
        ...
        test.log.info("***** Update the EF record #1 Provide Local Information command ****")
    ...
    if trigger_mode == 'MenuApplet':
        test.log.info("**** [SSTA=0]: Trigger execution of record #1 Provide Local Informatio command ****")
