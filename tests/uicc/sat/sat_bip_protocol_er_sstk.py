...
class Test(BaseTest):
    """
       TC0104630.001 -	TpSATBipProtocol_ER_SSTK
       Debugged: Viper
    ...
    def setup(test):
        ...
        test.dut.at1.send_and_verify('AT^SSTA=1', 'OK')
        ...
        if test.dut.platform is 'QCT':
           ...
           test.dut.at1.send_and_verify(r'AT^SSTR=5,0', 'OK')
           test.sleep(1)
           test.dut.at1.send_and_verify('AT^SSTGI=37', 'OK')
           test.dut.at1.send_and_verify(r'AT^SSTR=37,0', 'OK')
        else:
    ...
    def run(test):
        ...
        test.expect(test.dut.at1.send_and_verify('AT^SSTK="D013810301430182028121B6083132333435363738"',
                                                 'SSTK: "D013810301430182028121B6083132333435363738",21,"00".*SSTK: "8103014301[0|8]2028281[0|8]30100[3|B]701FF",15',
                                                 wait_for='.*SSTK: "D60E[1|9]90109[0|8]2028281[3|B]8028100[3|B]70108",16',timeout=60))
        ...
        test.expect(test.dut.at1.send_and_verify('AT^SSTK="D00C810301420082028121B70108"',
                                                 '.*SSTK: "D00C810301420082028121B70108",14.*SSTK: "8103014200[0|8]2028281[0|8]30100[3|B]6083132333435363738[3|B]70100",25'))
        ...
        test.expect(test.dut.at1.send_and_verify('AT^SSTK="D009810301440082028182"',
                                                 '.*SSTK: "D009810301440082028182",11.*SSTK: "8103014400[0|8]2028281[0|8]30100[3|B]8028100[3|B]8020200[3|B]8020300[3|B]8020400[3|B]8020500[3|B]8020600[3|B]8020700",40'))
        ...
        test.expect(test.dut.at1.send_and_verify('AT^SSTK="D009810301410082028121"',
                                                 '.*SSTK: "D009810301410082028121",11.*SSTK: "8103014100[0|8]2028281[0|8]30100",12',
